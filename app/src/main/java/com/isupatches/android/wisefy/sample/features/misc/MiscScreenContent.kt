        ...
        val onMiscOptionClicked: (MiscScreenOption) -> Unit = { option ->
            when (option) {
                ...
                MiscScreenOption.GET_FREQUENCY -> {
                    getFrequencyPermissionLauncher.launch(Manifest.permission.ACCESS_FINE_LOCATION)
                }
                MiscScreenOption.GET_IP -> getIPPermissionLauncher.launch(Manifest.permission.ACCESS_FINE_LOCATION)
                MiscScreenOption.GET_NEARBY_ACCESS_POINTS -> {
                    getNearbyAccessPointsPermissionsLauncher.launch(Manifest.permission.ACCESS_FINE_LOCATION)
                }

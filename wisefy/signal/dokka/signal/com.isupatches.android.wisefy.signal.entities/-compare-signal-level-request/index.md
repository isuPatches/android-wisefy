...
| | |
|---|---|
| [CompareSignalLevelRequest](-compare-signal-level-request.md) | [androidJvm]<br>constructor(rssi1: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), rssi2: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)) |

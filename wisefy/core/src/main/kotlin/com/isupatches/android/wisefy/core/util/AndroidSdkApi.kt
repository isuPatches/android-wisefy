...
/**
 * A default implementation of [AndroidSdkApi] that helps the library determine the SDK level of the device.
 *
 * @see AndroidSdkApi
 *
 * @author Patches Barrett
 * @since 12/2022, version 5.0.0
 */
class AndroidSdkImpl : AndroidSdkApi {
    @ChecksSdkIntAtLeast(api = Build.VERSION_CODES.P)

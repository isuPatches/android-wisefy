...
interface [CoroutineDispatcherProvider](index.md)
...
| |
|---|
| [DefaultCoroutineDispatcherProvider](../-default-coroutine-dispatcher-provider/index.md) |

## Properties

| Name | Summary |
|---|---|
| [io](io.md) | [androidJvm]<br>abstract val [io](io.md): CoroutineDispatcher<br>A reference to the I/O dispatcher for background operations. |
| [main](main.md) | [androidJvm]<br>abstract val [main](main.md): CoroutineDispatcher<br>A reference to the main dispatcher for UI operations. |

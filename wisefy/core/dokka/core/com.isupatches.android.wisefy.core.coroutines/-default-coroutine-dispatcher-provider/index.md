//[core](../../../index.md)/[com.isupatches.android.wisefy.core.coroutines](../index.md)/[DefaultCoroutineDispatcherProvider](index.md)

# DefaultCoroutineDispatcherProvider

[androidJvm]\
class [DefaultCoroutineDispatcherProvider](index.md) : [CoroutineDispatcherProvider](../-coroutine-dispatcher-provider/index.md)
...
| | |
|---|---|
| [DefaultCoroutineDispatcherProvider](-default-coroutine-dispatcher-provider.md) | [androidJvm]<br>constructor() |

## Properties

| Name | Summary |
|---|---|
| [io](io.md) | [androidJvm]<br>open override val [io](io.md): CoroutineDispatcher<br>A reference to the I/O dispatcher for background operations. |
| [main](main.md) | [androidJvm]<br>open override val [main](main.md): CoroutineDispatcher<br>A reference to the main dispatcher for UI operations. |

//[core](../../../../index.md)/[com.isupatches.android.wisefy.core.entities](../../index.md)/[PairwiseCipher](../index.md)/[Companion](index.md)
...
| Name | Summary |
|---|---|
| [ALL](-a-l-l.md) | [androidJvm]<br>val [ALL](-a-l-l.md): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)&lt;[PairwiseCipher](../index.md)&gt;<br>A list comprised of all of the representations of pairwise ciphers. |

...
internal class DefaultAccessPointsApiImplSearchForAccessPointsByBSSIDTest(
    private val params: SearchForAccessPointsByBSSIDParams
) {
    ...
    fun searchForAccessPointsBySSID() {
        ...
        // Then
        val result = apiImpl.searchForAccessPointsByBSSID(
    ...
    companion object {
        ...
        fun params(): List<SearchForAccessPointsByBSSIDParams> {
            return listOf(
                SearchForAccessPointsByBSSIDParams(
        ...
        data class SearchForAccessPointsByBSSIDParams(

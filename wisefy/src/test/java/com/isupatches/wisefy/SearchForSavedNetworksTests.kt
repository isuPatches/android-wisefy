...
internal class SearchForSavedNetworksTests : BaseUnitTest() {
    ...
    @Test fun async_failure_prechecks_nullCallback() {
        mockWiseFyPrechecksUtil.searchForSavedNetworks_failure()
        nullCallbackUtil.callSearchForSavedNetworks_withRegex(TEST_SSID)
    ...
    @Test fun async_success_nullCallbacks() {
        mockWiseFyPrechecksUtil.searchForSavedNetworks_success()

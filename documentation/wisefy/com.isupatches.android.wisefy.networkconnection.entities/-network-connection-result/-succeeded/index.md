...
| [copy](copy.md) | [androidJvm]<br>fun [copy](copy.md)(data: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)): [NetworkConnectionResult.Succeeded](index.md) |
...
| Name | Summary |
|---|---|
| [data](data.md) | [androidJvm]<br>val [data](data.md): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html) |

...
| [copy](copy.md) | [androidJvm]<br>fun [copy](copy.md)(data: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)): [AddNetworkResult.ResultCode](index.md) |
...
| Name | Summary |
|---|---|
| [data](data.md) | [androidJvm]<br>val [data](data.md): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) |

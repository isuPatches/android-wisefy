...
| [onSSIDFound](on-s-s-i-d-found.md) | [androidJvm]<br>abstract fun [onSSIDFound](on-s-s-i-d-found.md)(ssid: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |
| [onSSIDNotFound](on-s-s-i-d-not-found.md) | [androidJvm]<br>abstract fun [onSSIDNotFound](on-s-s-i-d-not-found.md)() |

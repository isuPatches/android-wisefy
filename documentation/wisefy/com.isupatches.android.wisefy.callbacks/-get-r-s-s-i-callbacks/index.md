...
| [onNoNetworkToRetrieveRSSI](on-no-network-to-retrieve-r-s-s-i.md) | [androidJvm]<br>abstract fun [onNoNetworkToRetrieveRSSI](on-no-network-to-retrieve-r-s-s-i.md)() |
| [onRSSIRetrieved](on-r-s-s-i-retrieved.md) | [androidJvm]<br>abstract fun [onRSSIRetrieved](on-r-s-s-i-retrieved.md)(rssi: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)) |
